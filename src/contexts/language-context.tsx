...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'admin_access_denied_desc': 'You do not have permission to view this page. This area is for administrators only.',
    ...
    'admin_machine_reg_desc': 'Add a new umbrella machine to the system.',
    ...
    'profile_settings_login_required': 'You need to be logged in to view profile settings.',
    'profile_settings_email_unchangeable': 'Email address cannot be changed here. Contact support for assistance.',
    ...
    'toast_password_change_error_title': 'Change Password Failed',
    'toast_password_change_error_desc': "Could not change password. Make sure your current password is correct and try again.",
    ...
    'terms_section_2_title': 'Disclaimer & Limitation of Liability',
    'terms_section_2_content_p1': "The U-Dry application and its services are provided on an 'as is' and 'as available' basis without any warranty or representation, whether express or implied. We do not guarantee that the service will be uninterrupted, timely, secure, or error-free.",
    'terms_section_2_content_p2': "To the maximum extent permitted by applicable law, in no event shall U-Dry be liable for any indirect, incidental, special, consequential or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from (a) your access to or use of or inability to access or use the service; (b) any conduct or content of any third party on the service; (c) any content obtained from the service; and (d) unauthorized access, use or alteration of your transmissions or content. This includes but is not limited to any physical, mental or monetary damages allegedly suffered as a result of using the application or its services.",
    'terms_section_3_title': 'Data Usage and Privacy',
    'terms_section_3_content': "By using U-Dry, you agree to the collection and use of information in accordance with our Privacy Policy [link to be added]. We may collect data related to your use of the app and service, such as rental history, location data (with your consent), and device information. This data may be used to improve our service, provide customer support, and for analytics. We are committed to protecting your privacy and handling your data responsibly.",
    'terms_section_4_title': 'User Responsibilities',
    'terms_section_4_content': "You are responsible for maintaining the confidentiality of your account and password and for restricting access to your device. You agree to accept responsibility for all activities that occur under your account or password. You are responsible for returning the rented umbrella on time and for reporting any damages or losses as per the application's guidelines. Misuse of the service or the umbrellas may result in account suspension or termination and a penalty equal to the security deposit being deducted from your available balance. All top-ups to your available balance are non-refundable.",
