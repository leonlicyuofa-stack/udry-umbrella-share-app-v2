...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'guide_step_3_description': "Use the umbrella for as long as you need. Your first rental is free! After that, it's HK$5 per hour, capped at HK$25 per 24-hour period. Remember to return it within 3 days (72 hours) to avoid forfeiting your deposit.",
  ...
  'zh-HK': {
    ...
    'guide_step_3_description': '您可以隨心所欲地使用雨傘。您的首次租借是免費的！之後，每小時收費 HK$5，每 24 小時上限為 HK$25。請記得在 3 天（72 小時）內歸還，以免被沒收按金。',
