...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'rental_timer_warning_36h': 'Warning: Max rental 72 hours. After 72 hours, deposit will be forfeited. To appeal, call {customerServiceNumber}.',
    'rental_timer_warning_72h': 'Rental exceeded 72 hours. Deposit (HK$100) forfeited. Please return umbrella.',
    ...
    'guide_step_3_description': "Use the umbrella for as long as you need. The first 30 minutes are free, then it's HK$5 per hour. The charge is capped at HK$25 per 24-hour period. Remember to return it within 3 days (72 hours) to avoid forfeiting your deposit.",
    ...
    'admin_verifying_access': 'Verifying access...',
    'admin_access_denied_title': 'Access Denied',
    'admin_access_denied_desc': 'You do not have permission to view this page. This area is restricted to administrators.',
    'admin_go_to_homepage_button': 'Go to Homepage',
    'admin_panel_main_title': 'U-Dry Admin Panel',
    'admin_welcome_message': 'Welcome, {userName}. Manage your U-Dry operations.',
    'admin_dashboard_overview_title': 'Dashboard Overview',
    'admin_dashboard_overview_desc': 'A quick look at operational data and analytics.',
    'admin_stat_total_stalls': 'Total Stalls',
    'admin_stat_total_stalls_desc': 'Currently operational',
    'admin_stat_total_umbrellas': 'Total Umbrellas',
    'admin_stat_total_umbrellas_desc': 'Across all stalls',
    'admin_stat_issues_reported': 'Issues Reported',
    'admin_stat_issues_reported_desc': 'Full tracking is a future feature',
    'admin_stat_avg_weekly_transactions': 'Avg Weekly Trans / Stall',
    'admin_stat_avg_weekly_transactions_desc': 'Baseline Average (Placeholder)',
    'admin_stat_avg_weekly_revenue': 'Avg Weekly Revenue / Stall',
    'admin_stat_avg_weekly_revenue_desc': 'Baseline Average (Placeholder)',
    'admin_stat_total_active_rentals': 'Total Active Rentals',
    'admin_stat_active_rentals_desc': 'Live ongoing rentals',
    'admin_stat_analytics_desc': 'Analytics will be enabled once database is integrated.',
    'admin_stat_total_borrowing': 'Total Borrows',
    'admin_stat_total_borrowing_desc': 'Since tracking began',
    'admin_stat_total_returns': 'Total Returns',
    'admin_stat_total_returns_desc': 'Since tracking began',
    'admin_stall_management_title': 'Stall Management',
    'admin_stall_management_desc': 'View, manage, and control individual umbrella stalls.',
    'admin_stall_availability_label': 'Availability:',
    'admin_stall_transactions_label': 'Transactions (This Week):',
    'admin_stall_revenue_label': 'Revenue (This Week):',
    'admin_stall_edit_button': 'Edit Details',
    'admin_stall_unlock_button': 'Unlock',
    'admin_stall_manage_features_soon': 'More stall management features are coming soon.',
    'admin_machine_reg_title': 'Machine Registration',
    'admin_machine_reg_desc': 'Add new umbrella machines to the system. (Placeholder)',
    'admin_machine_reg_placeholder_text': 'An interface to add a new machine, specify its ID, location, and initial umbrella count will be here.',
    'admin_machine_reg_add_button': 'Add Machine',
    'admin_stall_available_umbrellas_label': 'Available Umbrellas:',
    // Profile Settings Page
    'profile_settings_page_title': 'Profile Settings - U-Dry',
    'profile_settings_page_description': 'View and update your profile.',
    'profile_settings_title': 'Profile Settings',
    'profile_settings_description': 'Manage your account details and preferences.',
    'profile_settings_name_label': 'Name',
    'profile_settings_email_label': 'Email',
    'profile_settings_update_button': 'Update Profile',
    'profile_settings_update_success': 'Profile updated successfully!',
    'profile_settings_update_error': 'Failed to update profile.',
    'profile_settings_loading': 'Loading profile...',
    'profile_settings_login_required': 'You need to be logged in to view your profile settings.',
    ...
    'profile_settings_change_password_button': 'Change Password',
    'toast_password_change_success_title': 'Password Changed',
    'toast_password_change_success_desc': 'Your password has been successfully updated.',
    'toast_password_change_error_title': 'Password Change Failed',
    'toast_password_change_error_desc': 'Could not change password. Please ensure your current password is correct and try again.',
    'toast_password_mismatch': "The new passwords do not match.",
    'toast_reauth_required': "For security, please sign in again before changing your password.",
    // Terms and Conditions Page
    'terms_page_title': 'Terms and Conditions - U-Dry',
    'terms_page_description': 'Read the Terms and Conditions for using the U-Dry service.',
    'terms_content_title': 'Terms and Conditions',
    'terms_last_updated': 'Last Updated:',
    'terms_section_1_title': 'Introduction',
    'terms_section_1_content': "Welcome to U-Dry! These terms and conditions outline the rules and regulations for the use of U-Dry's Application and services. By accessing this app, we assume you accept these terms and conditions. Do not continue to use U-Dry if you do not agree to take all of the terms and conditions stated on this page.",
    'terms_section_2_title': 'Disclaimer and Limitation of Liability',
    'terms_section_2_content_p1': "The U-Dry application and its services are provided on an 'as is' and 'as available' basis without any warranties, express or implied. We do not warrant that the service will be uninterrupted, timely, secure, or error-free.",
    'terms_section_2_content_p2': "To the maximum extent permitted by applicable law, in no event shall U-Dry be liable for any indirect, incidental, special, consequential or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from (a) your access to or use of or inability to access or use the service; (b) any conduct or content of any third party on the service; (c) any content obtained from the service; and (d) unauthorized access, use or alteration of your transmissions or content. This includes, but is not limited to, any physical, mental, or financial damages allegedly sustained from the use of the application or its services.",
    'terms_section_3_title': 'Data Usage and Privacy',
    ...
    'terms_section_4_content': "You are responsible for maintaining the confidentiality of your account and password and for restricting access to your device. You agree to accept responsibility for all activities that occur under your account or password. You are responsible for returning rented umbrellas in a timely manner and reporting any damage or loss as per the app's guidelines. Misuse of the service or umbrellas may result in account suspension or termination and forfeiture of the security deposit.",
  ...
  'zh-HK': {
    ...
    'rental_timer_warning_36h': '警告：最長租借時間為 72 小時。超過 72 小時後，按金將被沒收。如需申訴，請致電 {customerServiceNumber}。',
    'rental_timer_warning_72h': '租借已超過 72 小時。按金 (HK$100) 已被沒收。請歸還雨傘。',
    ...
    'guide_step_3_description': '您可以隨心所欲地使用雨傘。首 30 分鐘免費，之後每小時 HK$5。每 24 小時的費用上限為 HK$25。請記得在 3 天（72 小時）內歸還，以免被沒收按金。',
    ...
    'terms_section_4_content': "您有責任維護您的帳戶和密碼的機密性，並限制對您設備的存取。您同意對在您的帳戶或密碼下發生的所有活動承擔責任。您有責任按時歸還租借的雨傘，並根據應用程式的指引報告任何損壞或遺失。濫用服務或雨傘可能導致帳戶暫停或終止以及按金被沒收。",
