...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'terms_section_4_content': "您有責任維護您的帳戶和密碼的機密性，並限制對您設備的存取。您同意對在您的帳戶或密碼下發生的所有活動承擔責任。您有責任按時歸還租借的雨傘，並根據應用程式的指引報告任何損壞或遺失。濫用服務或雨傘可能導致帳戶暫停或終止，以及從您的可用餘額中扣除等同於按金的罰款。所有增值至您可用餘額的資金均不設退款。",
