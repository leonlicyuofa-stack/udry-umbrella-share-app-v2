...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'rent_term_forfeit_deposit': 'Deposit will be forfeited if umbrella is not returned within 3 days (72 hours).',
  ...
  'zh-HK': {
    ...
    'rent_term_forfeit_deposit': '若 3 天（72 小時）內未歸還雨傘，將沒收按金。',
