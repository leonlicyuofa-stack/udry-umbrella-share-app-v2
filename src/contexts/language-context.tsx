...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'auth_error_invalid_credential_desc': 'Incorrect password, or this email is registered via Google or Apple. Please try a different sign-in method.',
    ...
    'forgot_password_desc': 'Enter your email below to receive a password reset link.',
    'forgot_password_sent_title': 'Request Sent',
    'forgot_password_sent_desc': "Please check your inbox for a link to reset your password. If you don't see it, check your spam folder.",
    ...
    'rent_dialog_rent_title_simple': 'Rent Umbrella',
    ...
    'refund_success_title': 'Refund Requested',
    'refund_success_desc': 'Your deposit refund has been processed. It may take 5-10 business days to appear on your statement.',
    'refund_error_title': 'Refund Failed',
    'refund_error_no_transaction_id': 'We could not locate your original payment record. Please contact support at support@u-dry.com with your account email and we will process your refund manually.',
  ...
  'zh-HK': {
    ...
    'auth_error_invalid_credential_desc': '密碼錯誤，或此電郵已透過 Google 或 Apple 註冊。請嘗試其他登入方式。',
    ...
    'forgot_password_desc': '請輸入您的電郵地址，我們將發送重設密碼連結。',
    'forgot_password_sent_title': '請求已發送',
    'forgot_password_sent_desc': '請檢查您的收件箱以獲取重設密碼連結。如未收到，請檢查垃圾郵件資料夾。',
    'forgot_password_back_to_signin': '返回登入',
    ...
    'rent_dialog_rent_title_simple': '租借雨傘',
    ...
    'refund_success_title': '退款申請已提交',
    'refund_success_desc': '您的按金退款已處理。款項可能需要 5-10 個工作天才會顯示在您的帳單上。',
    'refund_error_title': '退款失敗',
    'refund_error_no_transaction_id': '我們未能找到您的原始付款記錄。請以您的帳戶電郵聯絡 support@u-dry.com，我們將為您人工處理退款。',
