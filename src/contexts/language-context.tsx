...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'terms_section_4_content': "You are responsible for maintaining the confidentiality of your account and password and for restricting access to your device. You agree to accept responsibility for all activities that occur under your account or password. You are responsible for returning rented umbrellas in a timely manner and reporting any damage or loss as per the app's guidelines. Misuse of the service or umbrellas may result in account suspension or termination, and a penalty equal to the security deposit being charged to your spendable balance.",
