"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4358],{9009:function(e,t,n){n.d(t,{Bt:function(){return sT},F8:function(){return iB},JU:function(){return ix},PL:function(){return sm},QT:function(){return sd},ad:function(){return iO},cf:function(){return sy},hJ:function(){return iR},nP:function(){return sC},pl:function(){return sg},qs:function(){return sS},r7:function(){return sp},vr:function(){return sI}});var r,i,s,a,o=n(5723),l=n(6574),u=n(9858),h=n(8954),c=n(8597),d=n(2841);n(5566);var f=n(8620).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tp(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:J(t)?"-0":t}}function ty(e){return{integerValue:""+e}}function tv(e,t){return"number"==typeof t&&Number.isInteger(t)&&!J(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER?ty(t):tp(e,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tw{constructor(){this._=void 0}}function t_(e,t){return e instanceof tN?eA(t)||t&&"doubleValue"in t?t:{integerValue:0}:null}class tE extends tw{}class tT extends tw{constructor(e){super(),this.elements=e}}function tI(e,t){let n=tk(t);for(let t of e.elements)n.some(e=>eE(e,t))||n.push(t);return{arrayValue:{values:n}}}class tC extends tw{constructor(e){super(),this.elements=e}}function tS(e,t){let n=tk(t);for(let t of e.elements)n=n.filter(e=>!eE(e,t));return{arrayValue:{values:n}}}class tN extends tw{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function tA(e){return ed(e.integerValue||e.doubleValue)}function tk(e){return ek(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nN{constructor(){this.changes=new ta(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,eO.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();let n=this.changes.get(t);return void 0!==n?H.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nx{constructor(){this.Tr=new es(nL.Er),this.dr=new es(nL.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){let n=new nL(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new nL(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){let t=new K(new B([])),n=new nL(t,e),r=new nL(t,e+1),i=[];return this.dr.forEachInRange([n,r],e=>{this.Vr(e),i.push(e.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){let t=new K(new B([])),n=new nL(t,e),r=new nL(t,e+1),i=tm();return this.dr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nL(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nL{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return K.comparator(e.key,t.key)||O(e.wr,t.wr)}static Ar(e,t){return O(e.wr,t.wr)||K.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nB{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.$i=n,this.Ui=r}static Wi(e,t){let n=tm(),r=tm();for(let e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new nB(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iU{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new S(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new $(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iB{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new S(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new S(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return O(this._lat,e._lat)||O(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iz{constructor(e){this._values=(e||[]).map(e=>e)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;++n)if(e[n]!==t[n])return!1;return!0}(this._values,e._values)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let i$=/^__.*__$/;class iK{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new tP(e,this.data,this.fieldMask,t,this.fieldTransforms):new tF(e,this.data,t,this.fieldTransforms)}}class iQ{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new tP(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function iG(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I()}}class ij{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.vu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new ij(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Fu({path:n,xu:!1});return r.Ou(e),r}Nu(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Fu({path:n,xu:!1});return r.vu(),r}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return se(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(0===e.length)throw this.Bu("Document fields must not be empty");if(iG(this.Cu)&&i$.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class iW{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||n8(e)}Qu(e,t,n,r=!1){return new ij({Cu:e,methodName:t,qu:n,path:$.emptyPath(),xu:!1,ku:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iH(e){let t=e._freezeSettings(),n=n8(e._databaseId);return new iW(e._databaseId,!!t.ignoreUndefinedProperties,n)}function iY(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);i8("Data must be an object, but it was:",l,r);let u=i3(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i5(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);st(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iK(new eM(u),a,o)}class iX extends iq{_toFieldTransform(e){if(2!==e.Cu)throw 1===e.Cu?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof iX}}class iJ extends iq{_toFieldTransform(e){return new tb(e.path,new tE)}isEqual(e){return e instanceof iJ}}class iZ extends iq{constructor(e,t){super(e),this.Ku=t}_toFieldTransform(e){let t=new ij({Cu:3,qu:e.settings.qu,methodName:this._methodName,xu:!0},e.databaseId,e.serializer,e.ignoreUndefinedProperties),n=new tT(this.Ku.map(e=>i4(e,t)));return new tb(e.path,n)}isEqual(e){return e instanceof iZ&&(0,h.vZ)(this.Ku,e.Ku)}}class i0 extends iq{constructor(e,t){super(e),this.$u=t}_toFieldTransform(e){let t=new tN(e.serializer,tv(e.serializer,this.$u));return new tb(e.path,t)}isEqual(e){return e instanceof i0&&this.$u===e.$u}}function i1(e,t,n,r){let i=e.Qu(1,t,n);i8("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i7(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iX)s.push(o);else{let e=i4(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iQ(a,new eo(s),i.fieldTransforms)}function i2(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i5(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i5(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!st(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iX)u.push(t);else{let e=i4(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iQ(c,new eo(u),a.fieldTransforms)}function i4(e,t){if(i9(e=(0,h.m9)(e)))return i8("Unsupported field value:",t,e),i3(e,t);if(e instanceof iq)return function(e,t){if(!iG(t.Cu))throw t.Bu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Bu(`${e._methodName}() is not currently supported inside arrays`);let n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.xu&&4!==t.Cu)throw t.Bu("Nested arrays are not supported");return function(e,t){let n=[],r=0;for(let i of e){let e=i4(i,t.Lu(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return tv(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let n=P.fromDate(e);return{timestampValue:ni(t.serializer,n)}}if(e instanceof P){let n=new P(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:ni(t.serializer,n)}}if(e instanceof iB)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof iP)return{bytesValue:ns(t.serializer,e._byteString)};if(e instanceof ib){let n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.Bu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:no(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof iz)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Bu("VectorValues must only contain numeric values.");return tp(t.serializer,e)})}}}}};throw t.Bu(`Unsupported field value: ${iC(e)}`)}(e,t)}function i3(e,t){let n={};return et(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ee(e,(e,r)=>{let i=i4(r,t.Mu(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function i9(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof P||e instanceof iB||e instanceof iP||e instanceof ib||e instanceof iq||e instanceof iz)}function i8(e,t,n){if(!i9(n)||!("object"==typeof n&&null!==n&&(Object.getPrototypeOf(n)===Object.prototype||null===Object.getPrototypeOf(n)))){let r=iC(n);throw"an object"===r?t.Bu(e+" a custom object"):t.Bu(e+" "+r)}}function i5(e,t,n){if((t=(0,h.m9)(t))instanceof iU)return t._internalPath;if("string"==typeof t)return i7(e,t);throw se("Field path arguments must be of type string or ",e,!1,void 0,n)}let i6=RegExp("[~\\*/\\[\\]]");function i7(e,t,n){if(t.search(i6)>=0)throw se(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new iU(...t.split("."))._internalPath}catch(r){throw se(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function se(e,t,n,r,i){let s=r&&!r.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${i}`),l+=")"),new S(C.INVALID_ARGUMENT,o+e+l)}function st(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ib(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new sr(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(si("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class sr extends sn{data(){return super.data()}}function si(e,t){return"string"==typeof t?i7(e,t):t instanceof iU?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sd(e){e=iS(e,ib);let t=iS(e.firestore,iM);return(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ic({next:o=>{s.Za(),t.enqueueAndForget(()=>rU(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new r$(e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rP(e,a)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(iF(t),e._key).then(n=>sw(t,e,n))}class sf extends sa{constructor(e){super(),this.firestore=e}convertBytes(e){return new iP(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ib(this.firestore,null,t)}}function sm(e){e=iS(e,ik);let t=iS(e.firestore,iM),n=iF(t),r=new sf(t);return ss(e._query),(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ic({next:n=>{s.Za(),t.enqueueAndForget(()=>rU(e,a)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new r$(n,s,{includeMetadataChanges:!0,_a:!0});return rP(e,a)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sc(t,r,e,n))}function sg(e,t,n){e=iS(e,ib);let r=iS(e.firestore,iM),i=so(e.converter,t,n);return sv(r,[iY(iH(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tR.none())])}function sp(e,t,n,...r){e=iS(e,ib);let i=iS(e.firestore,iM),s=iH(i);return sv(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iU?i2(s,"updateDoc",e._key,t,n,r):i1(s,"updateDoc",e._key,t)).toMutation(e._key,tR.exists(!0))])}function sy(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iV(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iV(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof ib)a=iS(e.firestore,iM),o=e8(e._key.path),s={next:n=>{t[u]&&t[u](sw(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iS(e,ik);a=iS(n.firestore,iM),o=n._query;let r=new sf(a);s={next:e=>{t[u]&&t[u](new sc(a,r,n,e))},error:t[u+1],complete:t[u+2]},ss(e._query)}return function(e,t,n,r){let i=new ic(r),s=new r$(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rP(await iv(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rU(await iv(e),s))}}(iF(a),o,c,s)}function sv(e,t){return function(e,t){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>r2(await iy(e).then(e=>e.syncEngine),t,n)),n.promise}(iF(e),t)}function sw(e,t,n){let r=n.docs.get(t._key),i=new sf(e);return new su(e,i,t._key,r,new sl(n.hasPendingWrites,n.fromCache),t.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s_{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iH(e)}set(e,t,n){this._verifyNotCommitted();let r=sE(e,this._firestore),i=so(r.converter,t,n),s=iY(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,tR.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=sE(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof iU?i2(this._dataReader,"WriteBatch.update",s._key,t,n,r):i1(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tR.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=sE(e,this._firestore);return this._mutations=this._mutations.concat(new tz(t._key,tR.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new S(C.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function sE(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new S(C.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}function sT(){return new iJ("serverTimestamp")}function sI(...e){return new iZ("arrayUnion",e)}function sC(e){return new i0("increment",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
